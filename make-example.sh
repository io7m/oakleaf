...
--xinclude \
--noout \
--schema src/main/xsd/com/io7m/oakleaf/oakleaf-1.xsd src/main/example/article.xml

saxon \
-ea \
-xi \
-warnings:fatal \
-xsl:src/main/xsl/com/io7m/oakleaf/oakleaf-1.xsl \
-s:src/main/example/article.xml \
oakleafBranding=$(realpath src/main/example/brand.xml)

xmllint --noout --schema src/main/xsd/com/io7m/oakleaf/xhtml1-strict.xsd index.xhtml
mv index.xhtml out
